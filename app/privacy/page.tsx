...
export const metadata = {
  title: "Privacy Policy - Afora",
  description: "Afora Privacy Policy",
};
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <div className="bg-white rounded-lg shadow-lg p-8 space-y-6">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-gray-800">4. Information Sharing and Disclosure</h2>
          <p className="text-gray-600 leading-relaxed">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-gray-800">6. Your Rights and Choices</h2>
          <p className="text-gray-600 leading-relaxed mb-3">
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3 text-gray-800">7. Third-Party Services</h2>
          <p className="text-gray-600 leading-relaxed">
