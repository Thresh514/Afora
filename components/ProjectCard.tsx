    ...
    <a href={`/org/${orgId}/proj/${projId}`} className="block group">
      <Card className="h-full w-full overflow-hidden border border-border/70 bg-card">
        ...
        <CardHeader className="p-0 relative">
          <div className={`h-32 bg-gradient-to-r ${theme.bg} relative overflow-hidden`}>
            {/* Decorative elements */}
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              {projectName}&quot; and all its stages and tasks.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <Button
            ...
            <Button variant="destructive" onClick={handleDeleteProject} disabled={isPending}>
