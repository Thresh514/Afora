...
export default function AdminUserParticipation() {
  ...
  // 获取项目数据来检查用户是否是admin
  const [projectDoc, projectLoading] = useDocument(projId ? doc(db, "projects", projId) : null);
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          As an admin, you can choose to also participate in user activities like task assignments
          and team matching.
        </CardDescription>
      </CardHeader>
      <CardContent>
