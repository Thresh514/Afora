...
import { Check, Crown, Sparkles, Zap, Target, Users, BarChart3, ArrowRight } from "lucide-react";
      ...
      <AlertDialogContent className="w-full max-w-6xl p-0 overflow-hidden">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-foreground">
                        AI-driven team charter generation
                      </p>
                      <p className="text-sm text-muted-foreground">
                        AI-driven personalized team planning suggestions
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Deep team compatibility and performance insights
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        AI automatically creates and optimizes project tasks
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        24/7 dedicated customer support and technical support
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <Card className="border-l-4 border-l-green-500">
                    <CardContent className="p-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Real-time project insights and performance tracking, making management more
                        scientific
                      </p>
                    </CardContent>
                  </Card>
        ...
        <AlertDialogFooter className="bg-muted/50 p-6">
          <div className="flex flex-col sm:flex-row gap-3 w-2/3">
            <Button onClick={onCancel} variant="outline" className="w-1/3 sm:flex-none">
              Later
            </Button>
            <Button
              onClick={onUpgrade}
