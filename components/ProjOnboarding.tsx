    ...
    <>
      ...
      >
        <AlertDialogContent className="w-full max-w-2xl">
          ...
          {page === 0 && (
            <AlertDialogHeader>
              <AlertDialogTitle>Team Onboarding Survey</AlertDialogTitle>
              <AlertDialogDescription>
                Please take a minute to fill out this form. The information will be used for
                matching of teammates for your team. You can skip this for now, but it will appear
                again next time.
              </AlertDialogDescription>
            </AlertDialogHeader>
          )}
