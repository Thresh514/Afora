...
function MySidebar() {
  ...
  const [userOrgs] = useCollection(
    user &&
      ...
      collection(db, "users", user.primaryEmailAddress.toString(), "orgs")
  );
            ...
            <SidebarGroup>
              ...
              <SidebarGroupContent>
                <SidebarMenu>
                  ...
                  {loading && (
                    <SidebarMenuItem>
                      <div className="px-3 py-2 text-base text-gray-500">Loading groups...</div>
                    </SidebarMenuItem>
                  )}
                  ...
                  {error && (
                    <SidebarMenuItem>
                      <div className="px-3 py-2 text-base text-red-500">Error loading groups</div>
                    </SidebarMenuItem>
                  )}
                  ...
                  {!loading &&
                    !error &&
                    orgMap &&
                    Array.from(orgMap.entries()).map(([id, title]) => (
                  ...
                  {!loading && !error && orgMap && orgMap.size === 0 && orgIds.length === 0 && (
                    <SidebarMenuItem>
                      <div className="px-3 py-2 text-base text-gray-500">No groups found</div>
                    </SidebarMenuItem>
                  )}
                </SidebarMenu>
              </SidebarGroupContent>
