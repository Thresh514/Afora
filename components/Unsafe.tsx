      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div>
          ...
          >
            <SelectTrigger className="w-full max-w-xs">
              <SelectValue
                placeholder={(user?.unsafeMetadata?.gender as string) || "Select Gender"}
              />
            </SelectTrigger>
            <SelectContent>
              {genders.map((g) => (
        ...
        <div>
          ...
          >
            <SelectTrigger className="w-full max-w-xs">
              <SelectValue
                placeholder={(user?.unsafeMetadata?.demographic as string) || "Select Demographic"}
              />
            </SelectTrigger>
            <SelectContent>
          ...
          {errors.demographic && (
            <span className="text-red-500 text-sm">{errors.demographic.message}</span>
          )}
        </div>
