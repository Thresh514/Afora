...
import { Trophy, Medal, Award, Clock, CheckCircle, Target, Flame } from "lucide-react";
...
const Leaderboard: React.FC<LeaderboardProps> = ({ userScores, currentUserEmail }) => {
                      ...
                      <div key={user.userId} className={cardClassName}>
                        ...
                        <div className="flex-1">
                          ...
                          <div className="text-sm text-muted-foreground">
                            ...
                            {user.averageCompletionTime.toFixed(1)}h avg
                          </div>
                        </div>
                      ...
                      return (
                        <tr
                          ...
                          className={`border-b hover:bg-muted/50 ${
                            isCurrentUserRow ? "bg-primary/12 hover:bg-primary/18" : ""
                          }`}
                        >
                          <td className="py-3">
                            <div className="flex items-center gap-2">
