...
function HomePageCard({ org }: HomePageCardProps) {
  ...
  const [data, loading] = useDocumentData(org?.orgId ? doc(db, "organizations", org.orgId) : null, {
          ...
          <div className="flex flex-col h-96">
            ...
            <div className="relative">
              ...
              <div className="relative py-8 px-6">
                <h1
                  title={data?.title}
                  className="text-3xl font-bold tracking-tight text-white truncate"
                >
                  {data?.title}
                </h1>
              </div>
            ...
            <div className="flex-1 bg-white dark:bg-gray-800 p-6">
              <div className="space-y-6">
                ...
                <div className="border-t border-border/70 dark:border-gray-700 pt-4">
                  <h2 className="text-md text-foreground dark:text-gray-100 mb-2">Description:</h2>
                  <p
                    title={data?.description}
                    className="text-sm text-muted-foreground dark:text-gray-300 leading-relaxed line-clamp-3"
                  >
                    {data?.description}
                  </p>
                </div>
          ...
          >
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  This action will permanently delete this organization and all its contents,
                  removing all members. This action cannot be undone.
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4">
                <div className="space-y-2">
                  <Label htmlFor="org-name">
                    ...
                    <span className="font-semibold text-red-600">{orgName}</span> to confirm
                    deletion:
                  </Label>
                  <Input
                    id="org-name"
