          ...
          <div className="flex gap-4 items-center text-white">
            ...
            <SignedIn>
              ...
              <UserButton
                appearance={{
                  elements: {
                    formFieldInput: "!max-w-[min(100%,16rem)] w-full sm:!w-[16rem]",
                    formFieldRow: "flex-wrap items-center gap-2",
                    profileSectionContent__emailAddresses: "flex flex-col gap-2",
                    profileSectionPrimaryButton__emailAddresses: "w-fit self-start",
                  },
                }}
              />
            </SignedIn>
