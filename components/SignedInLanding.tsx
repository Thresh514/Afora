        ...
        <div className="w-full">
          <div className="rounded-xl border border-border bg-card/80 p-6 shadow-sm md:p-8">
            <div className="flex flex-col gap-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-foreground mb-4">Search your tasks</h3>
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="relative flex-1">
                    ...
                    <Input
                      ...
                      onKeyDown={(e) => {
                        if (e.key === "Enter") {
                          router.push(`/my-tasks?q=${encodeURIComponent(searchKeyword.trim())}`);
                        }
                      }}
      ...
      <div className="w-full pb-12">
        ...
        {orgs.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border border-border/70 bg-card/60 px-4 py-16 backdrop-blur-sm">
            ...
            />
            <h2 className="text-2xl font-semibold text-foreground mb-3">Create Your First Group</h2>
